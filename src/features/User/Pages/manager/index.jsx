...
function Managaer() {
    ...
    },
    {
      ...
      render:(text,data)=>{
        ...
        return <Fragment>
          ...
          <DeleteOutlined className={style.delete} style={{marginRight:"20px",fontSize:"25px"}} onClick={()=>{deleted(data.taiKhoan)}} >Delete</DeleteOutlined>
          <NavLink className={style.delete} style={{fontSize:"25px"}} key={2}  to={`/Updateaccount/${data.taiKhoan}`}><EditOutlined /></NavLink>
  ...
  return (
    <div>
      <h2 style={{textAlign:'center',fontSize:"30px",fontWeight:'700',marginTop:'20px',color:'blueviolet',fontFamily:'monospace'}}>DANH SÁCH NGƯỜI DÙNG</h2>
